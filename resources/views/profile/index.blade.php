                        ...
                        <div class="mt-4">
                            ...
                            <div class="mt-6.5">
                                ...
                                <div class="flex items-center justify-center gap-3.5">
                                    <a href="#" class="hover:text-primary" name="social-icon" aria-label="Facebook">
                                        <i class="fab fa-facebook-square text-2xl"></i>
                                    </a>
                                    <a href="#" class="hover:text-primary" name="social-icon" aria-label="Twitter">
                                        <i class="fab fa-twitter-square text-2xl"></i>
                                    </a>
                                    <a href="#" class="hover:text-primary" name="social-icon" aria-label="Instagram">
                                        <i class="fab fa-instagram-square text-2xl"></i>
                                    </a>
                                    <a href="#" class="hover:text-primary" name="social-icon" aria-label="LinkedIn">
