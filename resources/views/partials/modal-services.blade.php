...
<div id="service-modal" tabindex="-1" aria-hidden="true" data-modal-backdrop="static"
    ...
    <!-- Toast de error -->
    <div id="service-modal" class="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-sm dark:text-gray-400 dark:bg-gray-800" role="alert">
