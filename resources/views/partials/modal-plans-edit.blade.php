                                    ...
                                    <template x-for="servicio in getServicesForCategory(categoria.id)" :key="servicio.id">
                                        <li class="plans-service-item">
                                            ...
                                            <div x-show="openService === servicio.id"
                                                 ...
                                                 x-transition:leave-end="opacity-0 transform -translate-y-2"
                                                 class="overflow-hidden">
                                                <ul class="plans-list-container pl-6 divide-y divide-gray-200 dark:divide-gray-700">
                                                    <template x-for="plan in getPlansForService(servicio.id)" :key="plan.id">
                                                        <li class="flex items-center justify-between py-2 px-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600 rounded">
                                                            <div class="flex items-center justify-between w-full">
                                                                <div>
                                                                    <span class="font-medium" x-text="plan.nombre"></span>
                                                                    <span class="text-gray-500 dark:text-gray-400 ml-2">- $<span x-text="formatPrice(plan.precio)"></span></span>
                                                                </div>
    ...
    Alpine.data('editPlan', () => ({
        ...
        async updatePlan() {
            try {
                ...
                Swal.fire({
                    title: "Error",
                    text: error.message || "Hubo un problema al actualizar el plan.",
                    icon: "error",
                    customClass: {
                        confirmButton: "bg-red-500 hover:bg-red-600 text-white py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-red-400"
                    },
