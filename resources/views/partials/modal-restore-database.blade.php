            ...
            <div class="p-5">
                <div class="flex items-start space-x-4">
                    ...
                    <div class="flex-1">
                        ...
                        <div id="error-details" class="mt-3 text-sm text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-gray-800 p-3 rounded-lg hidden"></div>
                    </div>
                </div>
                ...
                fetch(this.action, {
                    ...
                    .catch(error => {
                        ...
                        if (messages.length > 1) {
                            errorDetails.innerHTML = messages.slice(1).map(msg => `• ${msg}`).join('<br>');
