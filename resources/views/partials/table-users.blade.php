<main class="h-full pb-16 overflow-y-auto">
    <div class="flex items-center justify-between flex-wrap md:flex-row md:space-y-0 p-4 bg-white dark:bg-gray-900">
                    ...
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                <div
                                    class="h-2.5 w-2.5 rounded-full {{ $user->isOnline() ? 'bg-green-500' : 'bg-red-500' }} me-2">
                                </div>
                        ...
                        <td class="px-6 py-4">
                            ...
                            <button data-modal-target="popup-modal-{{ $user->id }}"
                                ...
                                class="text-red-600 dark:text-red-500 hover:underline" type="button">
                                    ...
                                    <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                                        ...
                                        <div class="p-4 md:p-5 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">¿Estás
                                                seguro de que deseas eliminar este usuario?</h3>
