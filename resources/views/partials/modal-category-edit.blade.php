    ...
    @if (!auth()->user()->checkModuloAcceso('manage', 'actualizar'))
        ...
        <div class="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-sm dark:text-gray-400 dark:bg-gray-800"
            ...
            <button type="button"
                ...
                @click="closeListModal" aria-label="Close">
                        ...
                        <template x-for="categoria in filteredCategories" :key="categoria.id">
                            <li class="flex items-center justify-between p-0 text-sm text-gray-700 dark:text-gray-200">
                                <div
                                    ...
                                    <span @click="prepareEdit(categoria)" class="cursor-pointer p-2 w-full rounded"
                                        x-text="categoria.nombre"></span>
                                    <button type="button" @click="confirmDelete(categoria.id)"
            ...
            async confirmDelete(id) {
                ...
                if (result.isConfirmed) {
                    try {
                        ...
                        this.filteredCategories = this.filteredCategories.filter(cat => cat
                            .id !== id);
