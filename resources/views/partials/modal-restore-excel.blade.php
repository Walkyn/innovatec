    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div id="warning-message" class="hidden">
                <div class="flex w-full border-l-6 border-[#D0915C] bg-[#D0915C] bg-opacity-[15%] px-7 py-4 shadow-md dark:bg-[#1F2937] dark:bg-opacity-30 md:p-4 animate-fade-in-up">
            ...
            <div id="success-message" class="hidden">
                <div class="flex w-full border-l-6 border-[#34D399] bg-[#34D399] bg-opacity-[15%] px-7 py-4 shadow-md dark:bg-[#1F2937] dark:bg-opacity-30 md:p-4 animate-fade-in-up">
            ...
            <div id="error-message" class="hidden">
                <div class="flex w-full border-l-6 border-[#F87171] bg-[#F87171] bg-opacity-[15%] px-7 py-4 shadow-md dark:bg-[#1F2937] dark:bg-opacity-30 md:p-4 animate-fade-in-up">
            ...
            <div id="ignored-clients-section" class="hidden p-4 md:p-4 border-t border-gray-200 dark:border-gray-600">
                    ...
                    <div class="">
                        <label for="dropzone-file"
                            ...
                            <div id="dropzone-content" class="flex flex-col items-center justify-center pt-5 pb-6">
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400" id="file-size-display">Peso máximo: 50MB</p>
                            </div>
                            <input id="dropzone-file" type="file" name="archivo" class="hidden" accept=".xlsx,.xls" required />
                        </label>
                    </div>
                </form>
            </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        fileInput.addEventListener('change', function() {
            if (this.files.length) {
                ...
                dropzoneContent.innerHTML = `<span class="font-semibold">Archivo seleccionado:</span> ${file.name}`;
        ...
        importButton.addEventListener('click', function(event) {
            ...
            if (!fileInput.files.length) {
                ...
                document.getElementById('warning-text').innerText = "Por favor, seleccione un archivo antes de continuar.";
                return;
            }
            ...
            .then(data => {
                if (data.success) {
                    ...
                    document.getElementById('success-text').innerText = `Se importaron ${data.total_importados} clientes exitosamente.`;
            ...
            .catch(error => {
                errorMessage.classList.remove('hidden');
                document.getElementById('error-text').innerText = "Error al procesar la importación: " + error.message;
            })
            .finally(() => {
