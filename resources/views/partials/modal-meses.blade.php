                            ...
                            <div class="flex flex-col items-center py-4">
                                ...
                                <div class="flex flex-col items-center py-6">
                                    ...
                                    <div class="text-center">
                                        <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-1" data-field="nombre">Cargando...</h3>
                                        <p class="text-sm text-gray-500 dark:text-gray-400 flex items-center justify-center" data-field="fecha-inicio">
                                ...
                                <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-6 mb-4 bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                                    <!-- 1. Identificación -->
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-800 dark:text-white font-medium" data-field="identificacion">--</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-800 dark:text-white font-medium" data-field="telefono">--</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-800 dark:text-white font-medium" data-field="gps">--</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-800 dark:text-white font-medium" data-field="region">--</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-800 dark:text-white font-medium" data-field="provincia">--</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-800 dark:text-white font-medium" data-field="distrito">--</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-800 dark:text-white font-medium" data-field="pueblo">--</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="md:col-span-2 flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-800 dark:text-white font-medium" data-field="direccion">--</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="w-full bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <div>
                                                <p class="text-sm text-gray-500 dark:text-gray-400" data-field="plan">--</p>
                                                <p class="text-lg font-bold text-gray-800 dark:text-white" data-field="precio">--</p>
                                            </div>
                                        </div>
