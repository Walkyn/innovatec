                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        ...
                        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                            ...
                            <div class="relative">
                                ...
                                <input class="bg-white border border-gray-100 text-gray-900 text-sm rounded focus:ring-0 focus:border-gray-300 block w-full ps-10 p-3 cursor-not-allowed dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" id="cliente-telefono" disabled>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const cargarDetallesPago = async (cobranzaId) => {
        try {
            ...
            document.getElementById('monto-pago').textContent = `S/ ${cobranza.monto_pago_efectivo}`;
            document.getElementById('monto-cambio').textContent = `S/ ${cobranza.monto_cambio_efectivo}`;
